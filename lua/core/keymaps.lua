...
-- ToggleHLSearch
map('n', '<leader>hl', '<cmd>ToggleHLSearch<CR>', mapopts('Toggle hlsearch'))
...
map('n', 'grr', vim.lsp.buf.references, mapopts("LSP: References"))
map('n', 'grn', vim.lsp.buf.rename, mapopts("LSP: Rename"))
